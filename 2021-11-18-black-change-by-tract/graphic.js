...
var render = function () {
  ...
  d3.json("2020_black_change.json").then(function(data) {
    var regions = topojson.feature(data, data.objects['2020_black_change']);
    var geojson;
    ...
    function getColor(d) {
      ...
      return d < -250 ? colors.tangerine :
        ...
        function style(feature) {
            return {
              // update property
                  fillColor: getColor(feature.properties['2020_black_alone'] - feature.properties['2010_black_alone']),
                  weight: 1,
                  opacity: 0,
                  color: '#000',
                  fillOpacity: 0.7
          ...
          if (props) {
            if (props.tract_change == 'split') {
              ...
              var tract_change = ''
				     ...
				     this._div.innerHTML = '<h4>Black population change 2010-2020</h4>' 
					 ...
					 +  (
						 props ?
						 "<strong>Tract " + props.NAME20 + "</strong><br>2020 Black population: " + fmtComma(Math.round(props['2020_black_alone'])) + "<br>2010 Black population: " + fmtComma(Math.round(props['2010_black_alone'])) + tract_change
						 : 'Hover over a tract');
				 };
