    ...
    function getColor(d) {
      ...
      return d < -100 ? colors.tangerine :
          ...
          if (props) {
            if (props.tract_change == 'split') {
              ...
              var tract_change = ''
				     ...
				     this._div.innerHTML = '<h4>Latino population change 2010-2020</h4>' 
					 ...
					 +  (
						 props ?
						 "<strong>Tract " + props.NAME20 + "</strong><br>2020 Latino population: " + fmtComma(Math.round(props['2020_hispanic'])) + "<br>2010 Latino population: " + fmtComma(Math.round(props['2010_hispanic'])) + tract_change
						 : 'Hover over a tract');
				 };
        ...
        legend.onAdd = function (map) {
          ...
          var text = ['Lost more than 100','-100 to -25','-25 to 25','25 to 100','Gained more than 100']
          var labels = [];
