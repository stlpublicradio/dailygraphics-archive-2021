...
// population
  ...
  const pop_counties2 = pop_g.append("g")
      ...
      function getPopFill(d) {
        var pct = (d.properties.tot_2020 - d.properties.tot_2010) / d.properties.tot_2010

        var color = d3.scaleThreshold()
    .domain([-.10,-.05,0,.05,.10])
    .range(colorRange);
    ...
    var pop_labels_text = ["Lost more than 10%", "Lost between 5 and 10%", "Lost less than 5%", "Gained less than 5%", "Gained between 5 and 10%", "Gained more than 10%"]
