...
var render = function () {
  ...
  var map = new L.map('map', {
    ...
    attribution: ''
  }).setView(L.latLng(38.576,-90.611
    ), 10).setMaxBounds(bounds);
  ...
  d3.json("rockwood.topojson").then(function(data) {
    var regions = topojson.feature(data, data.objects.rockwood);
    var geojson;
